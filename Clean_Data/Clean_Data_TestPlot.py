...
start_time_GPS = 1185177007.112782 #change date here
...
ax1.plot(data1, label='Cropped to integer number of minutes')

#%% Remove median of whole dataset
data2 = data1 - np.median(data1)
ax1.plot(data2, label='Median subtracted')
...
ax1.plot(data3, label='One second median filtered')
