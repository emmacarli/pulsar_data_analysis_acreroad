...
polyco_table = pl.generate_polycos(model = B032954_model, mjdStart = 57969.1, mjdEnd = 57969.4, obs = 'acre', segLength = 10, ncoeff = 12, obsFreq = 407.5, method = 'TEMPO') #note segment length in minutes, observing frequency in MHz, method TEMPO2 unavailable
#the parameter file was obtained from ATNF

#%% Write to TEMPO style polyco table (PRESTO uses these for folding)
#polycos.tempo_polyco_table_writer(polyco_table, filename='PINT_polyco.dat')
